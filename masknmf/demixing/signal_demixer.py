...
class DemixingState(SignalProcessingState):
    ...
    def demix(
        ...
        self._results = DemixingResults(
            ...
            bkgd_corr_img_mean=background_to_signal_correlation_image.standard_correlation_image_mean,
            bkgd_corr_img_normalizer=background_to_signal_correlation_image.standard_correlation_image_normalizer,
